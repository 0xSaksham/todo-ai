...
export default function AddTaskInline({
  ...
  const defaultProject =
    projects.find((p) => p.type === "system") || projects[0];

  const projectId = myProjectId || parentTask?.projectId || defaultProject?._id;
  const labelId =
    parentTask?.labelId || ("k17fvzswh0s2mmee1fvg83bp297ehwk1" as Id<"labels">);
